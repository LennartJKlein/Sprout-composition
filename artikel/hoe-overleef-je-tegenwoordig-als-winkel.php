			...
			<div class="progressPanel">
				<ul class="progressPanel-list">
					<li class="progressPanel-item">
						<a href="hoe-overleef-je-tegenwoordig-als-winkel.php" class="progressPanel-link">
							<span class="progressPanel-title">Hoe overleef je tegenwoordig als winkel? Ondernemers vertellen</span>
							<span class="progressPanel-author">Jelmer Luimstra</span>
							<svg x="0px" y="0px" width="36px" height="36px" viewBox="0 0 36 36" class="progressPanel-svg"><circle class="progressPanel-circle" fill="none" stroke="#2a76e8" stroke-width="2" cx="18" cy="18" r="16" stroke-dasharray="100 100" stroke-dashoffset="100" transform="rotate(-90 18 18)"></circle></svg>
						</a>
					</li>
					<li class="progressPanel-item">
						<a href="7-redenen-waarom-klanten-je-winkel-de-rug-toekeren.php" class="progressPanel-link">
							<span class="progressPanel-title">7 redenen waarom klanten je winkel de rug toekeren</span>
							<span class="progressPanel-author">Fred Rutgers</span>
							<svg x="0px" y="0px" width="36px" height="36px" viewBox="0 0 36 36" class="progressPanel-svg"><circle class="progressPanel-circle" fill="none" stroke="#2a76e8" stroke-width="2" cx="18" cy="18" r="16" stroke-dasharray="100 100" stroke-dashoffset="100" transform="rotate(-90 18 18)"></circle></svg>
						</a>
					</li>
					<li class="progressPanel-item">
						<a href="waarom-retailers-het-contact-met-jongeren-kwijt-zijn-geraakt.php" class="progressPanel-link">
							<span class="progressPanel-title">Waarom retailers het contact met jongeren kwijt zijn geraakt</span>
							<span class="progressPanel-author">Fred Rutgers</span>
							<svg x="0px" y="0px" width="36px" height="36px" viewBox="0 0 36 36" class="progressPanel-svg"><circle class="progressPanel-circle" fill="none" stroke="#2a76e8" stroke-width="2" cx="18" cy="18" r="16" stroke-dasharray="100 100" stroke-dashoffset="100" transform="rotate(-90 18 18)"></circle></svg>
						</a>
					</li>
			...
			<section class="articles">
				...
				<article class="article">
					<header class="article-header">
						...
						<div class="article-hero figure">
							<img src="../images/article-hero.jpg" class="figure-image" />
					...
					<main class="article-content">
						...
						<blockquote class="article-blockquote" id="quote-ruud-stelder">De concurrentie is er keihard, waardoor veel retailers weer stenen winkels beginnen.</blockquote>
						...
						<div class="figure">
							<img src="../images/article-figure1.jpg" class="figure-image" />
						...
						<div class="figure">
							<img src="../images/article-figure2.jpg" class="figure-image" />
							<div class="figure-credit">
					...
					<footer class="article-footer">
						<?php include '../templates/shareactions.html' ?>
				...
				<article class="article">
					<header class="article-header">
						...
						<div class="article-hero figure">
							<img src="../images/article-hero3.jpg" class="figure-image" />
							<span class="figure-credit">&copy; Maikel Thijssen</span>
						</div>
						<div class="article-info">
							<div class="articleMeta">
							...
							<ul class="shareList shareList--row shareList--small">
								<li class="shareList-item">
									<a class="shareList-link shareList-link--facebook" href="#">
										<i class="fa fa-facebook"></i><span class="shareList-label">delen</span>
									</a>
								</li>
								<li class="shareList-item">
									<a class="shareList-link shareList-link--linkedin" href="#">
										<i class="fa fa-linkedin"></i><span class="shareList-label">delen</span>
									</a>
								</li>
								<li class="shareList-item">
									<a class="shareList-link shareList-link--twitter" href="#">
										<i class="fa fa-twitter"></i><span class="shareList-label">delen</span>
									</a>
								</li>
							</ul>
						</div>
				...
				<article class="article">
					<header class="article-header">
						...
						<div class="article-hero figure">
							<img src="../images/article-hero2.jpg" class="figure-image" />
