	...
	<div class="progressPanel">
		...
		<ul class="progressPanel__list">
			<li class="progressPanel__item">
				<a href="waarom-retailers-het-contact-met-jongeren-kwijt-zijn-geraakt.php" class="progressPanel__link">
					<span class="progressPanel__title">Waarom retailers het contact met jongeren kwijt zijn geraakt</span>
					<span class="progressPanel__author">Fred Rutgers</span>
					<svg x="0px" y="0px" width="36px" height="36px" viewBox="0 0 36 36" class="progressPanel__svg"><circle class="progressPanel__circle" fill="none" stroke="#2a76e8" stroke-width="2" cx="18" cy="18" r="16" stroke-dasharray="100 100" stroke-dashoffset="100" transform="rotate(-90 18 18)"></circle></svg>
				</a>
			</li>
			<li class="progressPanel__item">
				<a href="hoe-overleef-je-tegenwoordig-als-winkel.php" class="progressPanel__link">
					<span class="progressPanel__title">Hoe overleef je tegenwoordig als winkel? Ondernemers vertellen</span>
					<span class="progressPanel__author">Jelmer Luimstra</span>
					<svg x="0px" y="0px" width="36px" height="36px" viewBox="0 0 36 36" class="progressPanel__svg"><circle class="progressPanel__circle" fill="none" stroke="#2a76e8" stroke-width="2" cx="18" cy="18" r="16" stroke-dasharray="100 100" stroke-dashoffset="100" transform="rotate(-90 18 18)"></circle></svg>
				</a>
			</li>
			<li class="progressPanel__item">
				<a href="7-redenen-waarom-klanten-je-winkel-de-rug-toekeren.php" class="progressPanel__link">
					<span class="progressPanel__title">7 redenen waarom klanten je winkel de rug toekeren</span>
					<span class="progressPanel__author">Fred Rutgers</span>
					<svg x="0px" y="0px" width="36px" height="36px" viewBox="0 0 36 36" class="progressPanel__svg"><circle class="progressPanel__circle" fill="none" stroke="#2a76e8" stroke-width="2" cx="18" cy="18" r="16" stroke-dasharray="100 100" stroke-dashoffset="100" transform="rotate(-90 18 18)"></circle></svg>
				</a>
			</li>
	...
	<section class="articles">
		...
		<article class="article">
			<header class="article__header">
				...
				<h1 class="article__title">Waarom retailers het contact met jongeren kwijt zijn geraakt</h1>
				<div class="article__intro">Jongeren zijn via traditionele kanalen vrijwel onbereikbaar geworden. Daardoor zijn retailers zijn het contact verloren met jongeren, schrijft Sprout-expert Fred Rutgers.</div>
				
				<?php include '../templates/shareactions--wide.php'; ?>
				
				<div class="article__hero figure">
					<img src="../images/uploads/articles/article-hero2.jpg" class="figure__image" />
					<span class="figure__credit">&copy; E. G. Idee</span>
				</div>
					...
					<div class="articleAuthor">
						<div class="articleAuthor__summary">
							<a href="auteur.php" class="articleAuthor__link">
								...
								<span class="articleAuthor__company">Expert</span>
							</a>
						...
						<div class="articleAuthor__expand">
							...
							<div class="articleAuthor__social">
								...
								<a class="articleAuthor__sociallink button button--white button--small" href="http://nl.linkedin.com/in/fredrutgers" target="_blank"><i class="fa fa-linkedin"></i>@fredrutgers</a>
								<a class="articleAuthor__sociallink button button--white button--small" href="http://www.twitter.com/fredrutgers" target="_blank"><i class="fa fa-twitter"></i>fredrutgers</a>
							</div>
						</div>
					</div>
				</div>
			...
			<main class="article__content">
				...
				<blockquote id="quote-ruud-stelder" class="article__quote reveal" data-animate="flipInX" data-duration="1s" data-delay="0.2s" data-offset="100">De concurrentie is er keihard, waardoor veel retailers weer stenen winkels beginnen.</blockquote>
				...
				<ol>
					<li>Op de vraag wie er de afgelopen maand had gekeken naar publieke tv-zenders reageerde slechts 4% positief.</li>
					<li>Op de vraag wie de afgelopen maand had geluisterd naar een publieke radiozender reageerde niemand positief!</li>
					<li>Slechts 7% had de afgelopen maand een papieren krant gelezen!</li>
					<li>Niemand had het lokale huis aan huisblad gelezen in de afgelopen maand!</li>
					<li>Minder dan 10% wil überhaupt iets weten van aanbiedingen. Als ze iets willen kopen gaan ze zoeken op Google naar de beste deal of de laagste prijs!</li>
					<li>Meer dan de helft laat zich informeren door filmpjes op youtube.</li>
					<li>Meer dan 80% kijkt alleen naar content op het moment dat het hun uitkomt via een ander medium dan een tv-toestel. Het meest kijken ze via internet naar content on demand via een pc. Laptop of tablet.</li>
					<li>Ad blokkers en het skippen van advertenties is bijna standaard.</li>
				</ol>
				<p>Hieruit blijkt dat deze generatie vrijwel onbereikbaar is geworden voor de boodschappen die overheden en bedrijven de wereld in willen sturen.</p>
				<h2 id="leuk-nuttig-authentiek">Leuk, nuttig en authentiek</h2>
				<p>En toch kun je wel degelijk nog contact krijgen met deze doelgroep. Maar dan moet je het wel anders aanpakken. Deze jongeren vinden het erg belangrijk dat je boodschap leuk, nuttig en bovenal authentiek is. "Waarom" is hierbij de kern. De belangrijkste vragen die ze zichzelf stellen: Waarom zou ik ernaar willen kijken? Waarom moet ik er enthousiast voor worden? Waarom is dit voor mij de moeite waard? Dus die Engelse uitspraak “why” doet er meer toe dan je zou denken!</p>
				<p>Leuke filmpjes met een boodschap die subtiel het bericht over brengen en die worden aangeboden via Youtube, Instagram, Netflix, en virals via email trekken nog wel degelijk de aandacht. Als het bericht maar cool is, dan praten ze er onderling volop over en gaan ze het ook onderling delen.</p>
			...
			<footer class="article__footer">
				...
				<div class="articleAuthor articleAuthor--bottom">
					<div class="articleAuthor__content">
						...
						<p>Fred Rutgers is retailexpert en ondernemerscoach. 'Op basis van 30 jaar ervaring help ik retailers en ondernemers in de b2c sector om op een leuke manier en met minder stress te bouwen aan meer omzet...
						<div class="articleAuthor__social">
		...
		<article class="article reveal" data-animate="fadeInUp" data-duration="0.75s" data-delay="1.6s" data-offset="150">
			<header class="article__header">
				...
				<h1 class="article__title">Hoe overleef je tegenwoordig als winkel? Ondernemers vertellen</h1>
				<div class="article__intro">Succes hebben in de retailsector: het is niet iedereen gegund. Sprout is aanwezig bij een zogeheten rondetafel-discussie tussen ondernemers die er wel in slagen. Gespot: opvallend veel jonge ondernemers, die opvallend veel zien in stenen winkels.</div>
				
				<?php include '../templates/shareactions--wide.php'; ?>
				
				<div class="article__hero figure">
					<img src="../images/uploads/articles/article-hero.jpg" class="figure__image" />
				...
				<div class="article__info">
					...
					<div class="articleAuthor">
						<div class="articleAuthor__summary">
							<a href="auteur.php" class="articleAuthor__link">
								<img src="../images/uploads/avatars/jelmer-luimstra.jpg" class="articleAuthor__image" />
								<span class="articleAuthor__name">Jelmer Luimstra</span>
						...
						<div class="articleAuthor__expand">
							...
							<div class="articleAuthor__social">
								<a class="articleAuthor__sociallink button button--white button--small" href="#" target="_blank"><i class="fa fa-globe"></i>website</a>
								<a class="articleAuthor__sociallink button button--white button--small" href="http://nl.linkedin.com/in/jelmerluimstra" target="_blank"><i class="fa fa-linkedin"></i>@jelmerluimstra</a>
								<a class="articleAuthor__sociallink button button--white button--small" href="http://www.twitter.com/jelmerluimstra" target="_blank"><i class="fa fa-twitter"></i>jelmerluimstra</a>
							</div>
						</div>
					</div>
				</div>
			...
			<main class="article__content">
				<p>Een retaildiscussie bij maanlicht, dat is waar het deze maandagavond grofweg op neerkomt. Sprout mag aanschuiven voor een diner in het Amsterdamse Pulitzer Hotel, waar de Canadese Lightspeed-ceo Dax Dasilva en Neder-topman Ruud Stelder met Nederlandse ondernemers de stand van zaken binnen de retail bespreken. Lightspeed levert software voor ondernemers, en wil wel eens weten hoe zijn Nederlandse afnemers het doen.</p>
				<h2 id="winner-takes">The winner takes it all</h2>
				<p>Organiseer je een zakendiner, dan mag het je dinerpartners aan niets ontbreken. De Canadesen lijken dat te hebben begrepen. Het is een avond met servet op de broek, drie gangen, moeilijke ijsdesserts en zwijgzame obers die continu witte wijn bijschenken. We spotten één verdwaalde getatoeëerde arm, maar voor de rest vooral nette bloesjes en jasjes. Chique, zoals je het bij een Quote-feestje zou verwachten.</p>
				<p>Maar gelijk hebben ze, want vanavond gaat het dan ook over niets minder dan geldzaken. Want hoe verdien je tegenwoordig nog wat in de moeilijke sector van de retail? Stenen winkels vallen bij bosjes om, en online moet je eruit schieten om voldoende omzet te behalen. The winner takes all, en het idee van een winnaar is dat er doorgaans maar een van is. Deze avond staat in het teken van een discussie tussen retailondernemers die er daadwerkelijk in slagen het hoofd boven water te houden. Toch knap. Hoe doen ze dit?</p>
				<h2 id="millennials">Millennials</h2>
				...
				<h2 id="negatieve-reviews">Negatieve reviews</h2>
				...
				<div class="figure">
					<img src="../images/uploads/articles/article-figure2.jpg" class="figure__image" />
					<div class="figure__credit">
				...
				<blockquote class="article__quote reveal" id="quote-ruud-stelder" data-animate="flipInX" data-duration="1s" data-delay="0.2s" data-offset="100">De concurrentie is er keihard, waardoor veel retailers weer stenen winkels beginnen.</blockquote>
			...
			<footer class="article__footer">
				...
				<div class="articleAuthor articleAuthor--bottom">
					<div class="articleAuthor__content">
						...
						<div class="articleAuthor__social">
							<a class="articleAuthor__sociallink button button--primary button--small" href="#" target="_blank"><i class="fa fa-globe"></i>website</a>
							<a class="articleAuthor__sociallink button button--primary button--small" href="http://nl.linkedin.com/in/jelmerluimstra" target="_blank"><i class="fa fa-linkedin"></i>@jelmerluimstra</a>
							<a class="articleAuthor__sociallink button button--primary button--small" href="http://www.twitter.com/jelmerluimstra" target="_blank"><i class="fa fa-twitter"></i>jelmerluimstra</a>
						</div>
					</div>
				</div>
			</footer>
		...
		<article class="article reveal" data-animate="fadeInUp" data-duration="0.75s" data-delay="1.6s" data-offset="150">
			...
			<main class="article__content">
				...
				<h2>3. Vakkennis</h2>
				<p>Als ze in de winkel geen kennis hebben van wat ze verkopen kun je beter naar een webshop gaan. Daar staat alle productinfo overzichtelijk op een rijtje en krijg ik zelfs alternatieve keuzes aangeboden. Krijgt een klant echter te maken met een verkoper met vakkennis en inlevingsvermogen in de echte behoefte van een klant, dan vinden klanten dat advies van echte toegevoegde waarde en zijn dan meestal graag bereid om meer te betalen.</p>
				<h2>4. Toegevoegde waarde</h2>
				<p>Als je in een winkel jouw toegevoegde waarde niet tastbaar of merkbaar kunt maken, waarom zouden klanten daar dan voor willen betalen? Een veel gehoorde klacht in het onderzoek is dat winkeliers te weinig moeite doen om een stapje extra te doen voor een klant. Bij minimale service hoort ook echt de minimale prijs, anders zoekt de klant elders wel de beste deal!</p>
				<h2>5. Cadeautje</h2>
				<p>Een belangrijke reden voor de klant om bij een winkel te kopen in plaats van bij een webshop is dat het gaat om een cadeau. Daarbij noemen ze twee redenen. De eerste is dat ruilen in een winkel gemakkelijker is dan bij een webshop. De ontvanger kan dan met minder moeite even zijn cadeau ruilen. Bovendien pakken webshops vrijwel nooit een cadeau leuk in. Als een winkel dat wel doet is dit een belangrijke reden om te kiezen voor die winkel. Zelfs als de klant eventueel iets extra moet betalen voor een luxe cadeauverpakking.</p>
				<h2>6. Kletsend personeel</h2>
				<p>Klanten haten personeel dat onderling praat tijdens het helpen van een klant! Erger nog vinden ze het als personeel “druk is op de telefoon” terwijl ze achter de toonbank of in de winkel staan. Voor veel klanten is dat één van de belangrijkste redenen om die winkel voortaan niet meer te bezoeken! Ook ergeren klanten zich enorm aan personeel dat niet achter de kassa of toonbank weg te slaan is terwijl de klant even advies vraagt of iets niet kan vinden.</p>
				<p>Meer dan de helft van de klanten gaf aan in dergelijke gevallen van de koop af te zien! Voor bijna dertig procent was dat ook reden om voortaan een dergelijke winkel minder te bezoeken! </p>
				<h2>7. Geen aftersales</h2>
...
<aside id="aside">
	...
	<div class="aside__panelgroup">
		<?php include '../templates/widgets/partnerhighlight.php'; ?>
