...
<aside id="aside">
    ...
    <div class="aside__panelgroup">
        ...
        <div class="panel">
            ...
            <ul class="linkList">
                <li class="linkList__item"><a class="linkList__link" href="/topic/direct-marketing.php">Retail</a></li>
                <li class="linkList__item"><a class="linkList__link" href="/topic/direct-marketing.php">Crowdfunding</a></li>
            </ul>
        </div>
    </div>
