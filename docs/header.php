<?php include '../templates/header.php'; ?>
	...
	<div class="main-body">
		...
		<p>Daarnaast is het belangrijk dat er een icoon uit de <a href="https://fontawesome.com/v4.7.0/icons/" target="_new">FontAwesome bibliotheek v4.7.0</a> toegevoegd kan worden aan de tekst in het menu-item.</p>
		...
		<pre class="codeBlock"><code class="prettyprint lang-html"><?php echo trim(preg_replace('/\t+/', '', htmlentities('
			<nav class="nav">
			    <div class="nav-head">
			        ...
			        <div class="search-resultscontainer">...</div>
			        
			        <ul class="menu menu--main">
			            <li class="menu-item current-menu-item" hint="Item 1">
			                <a href="#" class="menu-link">
			                    <i aria-hidden="true" class="fa fa-newspaper-o"></i>
			                    <span class="menu-label">Item 1</span>
			                </a>
			            </li>
			            <li class="menu-item" hint="Item 2">
			                <a href="#" class="menu-link">
			                    <i aria-hidden="true" class="fa fa-calendar-o"></i>
			                    <span class="menu-label">Item 2</span>
			                </a>
			            </li>
			            <li class="menu-item" hint="Item 3">
			                <a href="#" class="menu-link">
			                    <i aria-hidden="true" class="fa fa-paper-plane"></i>
			                    <span class="menu-label">Item 3</span>
			                </a>
			            </li>
			            <li class="menu-item" hint="Item 4">
			                <a href="#" class="menu-link">
			    ...
			    <div class="nav-footer">
			        ...
			        <ul class="menu menu--tools">
			            <li class="menu-item" hint="Item 5">
			                <a href="#" class="menu-link">
		...
		'))) ?></code></pre>
		<h3>3. Highlighten van huidige menu-item</h3>
		<p>Met behulp van de class <code>.current-menu-item</code> moet uiteindelijk de huidige pagina worden gearceerd. In deze statische browser composition is dat het item 'nieuws'.</p>
