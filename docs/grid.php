<?php include '../templates/header.php'; ?>
	...
	<div class="main__body">
		...
		<p>Het grid gaat uit van 12 kolommen, welke samen een breedte van 100% hebben. In een grid plaats je cellen met de class <code>grid__cell</code>, welke een bepaald aantal kolommen breed zijn. Standaard is elke cel 12 kolommen breed.</p>
		<div class="notification">Alle cellen in een grid krijgen dezelfde breedte, tenzij een cell de class <code>.grid__cell--wide</code> heeft. In dat geval is de cell altijd 12 kolommen breed.</div>
