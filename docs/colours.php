	...
	<div class="main__body">
		...
		<div class="grid grid--mobile-6 grid--tablet-4">
			<div class="grid__cell">
				...
				<h4><big><span class="headingIcon fa fa-square text--secondary"></span></big> $color-secondary</h4>
				<h4><big><span class="headingIcon fa fa-square text--secondary-light"></span></big> $color-secondary-light</h4>
			...
			<div class="grid__cell">
				...
				<h4><big><span class="headingIcon fa fa-square text--white"></span></big> $color-white</h4>
				<h4><big><span class="headingIcon fa fa-square text--black"></span></big> $color-black</h4>
				<h4><big><span class="headingIcon fa fa-square text--grey"></span></big> $color-grey</h4>
				<h4><big><span class="headingIcon fa fa-square text--grey-light"></span></big> $color-grey-light</h4>
				<h4><big><span class="headingIcon fa fa-square text--grey-dark"></span></big> $color-grey-dark</h4>
			</div>
		</div>
