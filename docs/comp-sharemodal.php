<?php include '../templates/header.php'; ?>
	...
	<header class="main-header">
		<h1 class="main-title">shareModal</h1>
		<div class="main-intro">Dit component is popup (een modal) met social sharing opties voor smartphones.</div>
	</header>
	...
	<div class="main-body">
		...
		<pre class="codeBlock"><code class="prettyprint"><?php echo trim(preg_replace('/\t+/', '', htmlentities('
			<div id="shareModal">
				<ul class="shareList shareList--modal">
				     <li class="shareList-item">
				          <a class="shareList-link shareList-link--whatsapp" href="whatsapp://send?text=#URL">
				               <i class="fa fa-whatsapp"></i><span class="shareList-label"><strong>Delen</strong></span>
				          </a>
				     </li>
				     <li class="shareList-item">
