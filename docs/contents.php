...
<ul class="linkList linkList--spaced">
	<li class="linkList__item"><a class="linkList__link" href="typography.php">Typografie</a></li>
	<li class="linkList__item"><a class="linkList__link" href="colours.php">Kleuren</a></li>
	<li class="linkList__item"><a class="linkList__link" href="comp-buttons.php">Buttons</a></li>
	<li class="linkList__item"><a class="linkList__link" href="icons.php">Iconen</a></li>
	<li class="linkList__item"><a class="linkList__link" href="animations.php">Animaties</a></li>
	<li class="linkList__item"><a class="linkList__link" href="grid.php">Grid</a></li>
	<li class="linkList__item"><a class="linkList__link" href="header.php">Header</a></li>
	<li class="linkList__item"><a class="linkList__link" href="404.php">404</a></li>
</ul>

<h3><i class="headingIcon fa fa-user"></i>Profielen</h3>
<ul class="linkList linkList--spaced">
	<li class="linkList__item"><a class="linkList__link" href="roles.php">Rollen</a></li>
	<li class="linkList__item"><a class="linkList__link" href="profile-person.php">Gebruikersprofiel</a></li>
	<li class="linkList__item"><a class="linkList__link" href="profile-company.php">Bedrijfsprofiel</a></li>
	<li class="linkList__item"><a class="linkList__link" href="premium.php">Premium</a></li>
</ul>

<h3><i class="headingIcon fa fa-sticky-note"></i>Post types</h3>
<ul class="linkList linkList--spaced">
	<li class="linkList__item"><a class="linkList__link" href="post-article.php">Artikel</a></li>
	<li class="linkList__item"><a class="linkList__link" href="post-partnerarticle.php">Persbericht</a></li>
	<li class="linkList__item"><a class="linkList__link" href="post-event.php">Event</a></li>
	<li class="linkList__item"><a class="linkList__link" href="post-partnerevent.php">Partner event</a></li>
</ul>

<h3><i class="headingIcon fa fa-file"></i>Page types</h3>
<ul class="linkList linkList--spaced">
	<li class="linkList__item"><a class="linkList__link" href="page-default.php">Default page</a></li>
	<li class="linkList__item"><a class="linkList__link" href="page-list.php">Lijst</a></li>
	<li class="linkList__item"><a class="linkList__link" href="page-listitem.php">Lijst-item</a></li>
	<li class="linkList__item"><a class="linkList__link" href="page-topic.php">Topic</a></li>
</ul>

<h3><i class="headingIcon fa fa-puzzle-piece"></i>Widgets</h3>
<ul class="linkList linkList--spaced">
	<li class="linkList__item"><a class="linkList__link" href="widgets.php">Widgets</a></li>
</ul>
