<?php include '../templates/header.php'; ?>
	...
	<header class="main__header">
		<h1 class="main__title">Figure</h1>
		<div class="main__intro">Dit component wordt gebruikt voor alle afbeeldingen in de site. Dit component zorgt er onder andere voor dat de container met de afbeelding meeschaalt, maar de afbeelding ook altijd netjes tot de randen van de container wordt geknipt.</div>
	</header>
