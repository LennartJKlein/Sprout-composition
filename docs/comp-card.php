<?php include '../templates/header.php'; ?>
	...
	<header class="main__header">
		<h1 class="main__title">Card</h1>
		<div class="main__intro">Dit component is een belangrijke sleutel in deze browser composition. De card is soort een samenvatting van een pagina of post die als link doorverwijst naar die content. De vormgeving en idee&euml;n hierover zijn afgeleid van Google's Material Design.</div>
	</header>
