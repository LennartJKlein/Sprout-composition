        ...
        <div class="grid-cell grid-cell--wide">
            <a href="evenement/the-next-web-conference-2018.php" class="card card--event card--tablet-horizontal card--tabletlandscape-big card--tabletlandscape-textfirst" tag="startups">
                ...
                <div class="card-content">
                    ...
                    <h3 class="card-title">The Next Web Conference 2018</h3>
                    ...
                    <div class="card-button">Bekijk event</div>
                </div>
            </a>
        </div>
        <div class="grid-cell">
            <a href="evenement/nk-pitchen-2018.php" class="card card--event card--horizontal" tag="scaleups">
                ...
                <div class="card-content">
                    ...
                    <h3 class="card-title">NK Pitchen 2018</h3>
                    ...
                    <span class="card-button">Bekijk event <i class="fa fa-chevron-right" aria-hidden="true"></i></span>
                </div>
            </a>
        </div>
        <div class="grid-cell">
        ...
        <div class="grid-cell">
            <a href="evenement/the-next-web-conference-2018.php" class="card card--event card--horizontal" tag="investeren">
                ...
                <div class="card-content">
                    ...
                    <h3 class="card-title">Amsterdam Talks Tech: the Education Edition</h3>
        ...
        <div class="grid-cell">
            <a href="evenement/the-next-web-conference-2018.php" class="card card--partner card--horizontal" tag="scaleups">
                ...
                <div class="card-content">
                    ...
                    <h3 class="card-title">Affiliateblogger Sessions</h3>
        ...
        <div class="grid-cell">
            <a href="evenement/the-next-web-conference-2018.php" class="card card--partner card--horizontal" tag="scaleups">
                ...
                <div class="card-content">
                    ...
                    <h3 class="card-title">StartupDelta Summit</h3>
