<div class="shareActions shareActions--fluid">
	<ul class="shareList shareList--row">
		...
		<!-- <li class="shareList__item">
			<a class="shareList__link shareList__link--mail" href="#">
				<i class="fa fa-envelope"></i><span class="shareList__label">email</span>
			</a>
		</li> -->
	</ul>
</div>