			...
			<div class="search__resultscontainer">
				...
				<div class="grid grid--12">
					<div class="grid__cell">
						<div class="articleList" type="artikel">
							<a href="/artikel/hoe-overleef-je-tegenwoordig-als-winkel.php" class="articleList__article">
								...
								<div class="articleList__tags">
									<div class="articleList__tag">artikel</div>
								</div>
							</a>
							<a href="/artikel/hoe-overleef-je-tegenwoordig-als-winkel.php" class="articleList__article">
						...
						<div class="articleList" type="persbericht">
							<a href="/artikel/hoe-overleef-je-tegenwoordig-als-winkel.php" class="articleList__article">
								<h3 class="articleList__article-title">Deze ondernemer helpt game-ontwikkelaars aan een investeerder</h3>
								<div class="articleList__tags">
									<div class="articleList__tag">persbericht</div>
								</div>
							</a>
							<a href="/artikel/hoe-overleef-je-tegenwoordig-als-winkel.php" class="articleList__article">
								<h3 class="articleList__article-title">Oud-ondernemer Netflix: 'Voor 10 dollar onbeperkt naar de bios'</h3>
						...
						<div class="articleList" type="onderneming">
							<a href="/bedrijf/present-your-startup.php" class="articleList__article">
								<h3 class="articleList__article-title">PostNL</h3>
								<div class="articleList__tags">
									<div class="articleList__tag">onderneming</div>
								</div>
							</a>
							<a href="/bedrijf/present-your-startup.php" class="articleList__article">
								<h3 class="articleList__article-title">Hemax</h3>
								<div class="articleList__tags">
									<div class="articleList__tag">onderneming</div>
								</div>
							</a>
							<a href="/bedrijf/present-your-startup.php" class="articleList__article">
								<h3 class="articleList__article-title">FestivalWallet</h3>
								<div class="articleList__tags">
									<div class="articleList__tag">onderneming</div>
								</div>
							</a>
